---
title: "Como realizar a análise espacial da mortalidade infantil"
description: |
...
# Importar dados sobre mortalidade infantil do Instituto
...
# transformando em simple feature (fonte: Instituto Brasileiro
...
# I de Moran = 0.28643100,  p-value = 5.166e-06
...
# Realizando o escore Z para geração do diagrama de espalhamento de Moran
...
# Criando um vetor que contenha o centro das observações da variável mortalidade infantil ao redor de sua média:
